...
function onUpdatePost(elapsed)
    for a = 0, getProperty('notes.length') - 1 do
		...
		if not mustPress and noteType == 'Hurt Note (Miss Anim)' then
			if (strumTime - getSongPosition()) / getProperty('songSpeed') < 1 and getPropertyFromGroup('notes', a, 'active') and getRandomBool(99, 100) then
