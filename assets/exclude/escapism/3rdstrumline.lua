...
local player3 = 'minus' -- Change this to your LUA character
...
function onCreatePost()
	...
	for i=1, #directions do
		makeAnimatedLuaSprite('strum'..directions[i], 'NOTE_assets', getPropertyFromGroup('playerStrums', i-1, 'x') + 146--[[screenWidth / 2 - 2*177 + 105 * i--]], defaultstrumy - 100)
		if not downscroll then
